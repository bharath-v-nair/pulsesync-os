...
export const HABIT_BENCHMARKS: HabitBenchmark[] = [
  {
    id: 'sleep',
    name: 'Circadian Sleep',
    category: 'sleep',
    unit: 'hours',
    baselineWeekly: 56.0, // 8.0h / day
    stretchWeekly: 59.5,  // 8.5h / day
    description: 'Target restorative 90m sleep cycles',
  },
  {
    id: 'sunlight',
  ...
  },
  {
    ...
    category: 'hydration',
    unit: 'liters',
    baselineWeekly: 24.5, // 3.5L / day (5x 700ml bottles)
    stretchWeekly: 28.0,  // 4.0L / day
    description: 'Daily fluid turnover (5x 700ml bottles)',
  },
  {
    id: 'cleanDay',
    name: 'Clean Days',
    ...
    baselineWeekly: 6,    // 6 / 7 days
    stretchWeekly: 7,     // 7 / 7 days
    description: 'Whole foods, zero doomscroll, supps, bed made',
  },
  {
    id: 'reading',
    name: 'Deep Reading',
    ...
    description: 'Technical mastery & deliberate practice',
  },
];
